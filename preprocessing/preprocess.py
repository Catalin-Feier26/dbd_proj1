        ...
        with open(OUTPUT_FILE_PATH, 'w', encoding='utf-8') as f_out:
            for app_id, game_data in data.items():
                try:
                    ...
                    # Validate and dump this single object
                    # This try/except will catch bad data
                    # (like the unescaped quotes)
                    json.dump(game_data, f_out)
                    
                    # If dump succeeds, write newline and count
                    f_out.write('\n')
                    count_success += 1
                
                except (TypeError, ValueError) as e:
                    # This game object is corrupt. Log it and skip.
